...
import { getTrainingHistoryByEmpAndTrainingId, getTrainingHistoryByEmpId } from "../api/EmployeeTrainingHistoryApiService";

export default function ViewTrainingHistory() {
    ...
    () => 
        {               
            if (!didFetchRef.current) {
                ...
                getEmployeeTrainingHistoryByEmpId()
            }
        },[]) 
    ...
    function getEmployeeTrainingHistoryByEmpId() {
   ...
   return(
        <div className="container">
            <Box >
                <Typography variant="h4" gutterBottom>View All Trainings History </Typography>
