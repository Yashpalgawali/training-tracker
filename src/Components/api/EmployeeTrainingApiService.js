...
export const retrieveAllEmployeesByTrainingAndCompetencyId = (tid,compid) => apiClient.get(`employee-training/training/${tid}/competency/${compid}`)
...
export const getTrainingsCountByEmployeeTrainingId = (tid) => apiClient.get(`employee-training/count/training/${tid}`)
